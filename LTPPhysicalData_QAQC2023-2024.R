...
WQ2$Time <- strptime(WQ2$Time, format = "%H:%M", tz = "") %>%
  strftime(WQ2$Time, format = "%H:%M:%S", tz = "", usetz = FALSE,
           digits = getOption("digits.secs"))     # use digits = getoption to function correctly
...
sec <- c(708, 1090)
do <- c(1409, 1314, 1218, "STTD_2022-02-07 10:17:00", "STTD_2022-03-14 09:27:00", "STTD_2024-18-11 09:55:00")
